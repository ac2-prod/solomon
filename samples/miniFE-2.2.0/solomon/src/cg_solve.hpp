...
void cg_solve(OperatorType& A,
  ...
  PRAGMA_OMP_TARGET_ENTER_DATA_MAP_TO(r_ptr[:r.coefs.size()], p_ptr[:p.coefs.size()], Ap_ptr[:Ap.coefs.size()], x_ptr[:x.coefs.size()], b_ptr[:b.coefs.size()], Arowoffsets[:A.row_offsets.size()], Acols[:A.packed_cols.size()], Acoefs[:A.packed_coefs.size()])
  ...
  PRAGMA_OMP_TARGET_EXIT_DATA_MAP_FROM(r_ptr[:r.coefs.size()], p_ptr[:p.coefs.size()], Ap_ptr[:Ap.coefs.size()], x_ptr[:x.coefs.size()], b_ptr[:b.coefs.size()], Arowoffsets[:A.row_offsets.size()], Acols[:A.packed_cols.size()], Acoefs[:A.packed_coefs.size()])
